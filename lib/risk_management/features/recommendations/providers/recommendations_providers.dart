...
final recommendationsProvider = FutureProvider.autoDispose
    .family<List<String>, String>((ref, riskLevel) async {
  ...
  try {
    ...
    print(
        'recommendationsProvider: ${recommendations.length} recommandations récupérées pour "$riskLevel".');
    return recommendations;
  } catch (e, s) {
    print(
        'recommendationsProvider: Erreur lors de l\'appel à getRecommendations pour "$riskLevel": $e\nStackTrace: $s');
