...
@HiveType(
    typeId: 2) // ID unique pour Asset (doit être différent des autres modèles)
class Asset {
  @HiveField(0)
  ...
  @HiveField(3)
  final String
      imageUrl; // URL de l'image (peut être null dans certaines réponses)
  @HiveField(4)
  ...
  factory Asset.fromJson(Map<String, dynamic> json) {
    return Asset(
      ...
      currentPrice: (json['current_price'] as num? ?? 0.0)
          .toDouble(), // Accès à 'current_price'
      priceChange24h: (json['price_change_24h'] as num? ?? 0.0)
          .toDouble(), // Accès à 'price_change_24h'
      priceChangePercentage24h:
          (json['price_change_percentage_24h'] as num? ?? 0.0)
              .toDouble(), // Accès à 'price_change_percentage_24h'
  ...
  Asset copyWith({
    ...
    return Asset(
      ...
      symbol: symbol,
      name: name,
      imageUrl: imageUrl, // L'URL de l'image change rarement
